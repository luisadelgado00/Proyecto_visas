        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center " >
                    ...
                    <h1 style="font-color: white">visas continental</h1>
                        Styles 
                    ...
                    <h4 class="titulo">Bienvenido a Visas Continental</h4>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://visascontinental.com/" class="underline text-gray-900 dark:text-white">Visas Continental</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    En la pagina de Visas Continental podras encontrar informacion sobre la empresa y de los procesos que se pueden llevar a cabo.
                                </div>
                            </div>
                        </div>
