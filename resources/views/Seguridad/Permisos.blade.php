                    ...
                    <tr>
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-xs">Tipo de permiso</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-gray-500 hover:bg-gray-200 dark:hover:bg-grey-600 dark:text-gray-300">
                                <td class="px-4 py-1 text-xs">{{$permisos->id}}</td>
                                <td class="px-4 py-1 text-xs">{{$permisos->name}}</td>
                                <!--<td>
                                    <div class="trans">
                                    <a class="btn btn-primary" href="{{url('/Permisos/'.$permisos->id.'/edit')}}" role="button" id="bEdit">
                                    EDITAR</a></br></div>
