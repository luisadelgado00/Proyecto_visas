...
<x-app-layout>
            ...
            <br><input type="image"  src="{!! asset('images/usuario.png') !!}" width="200px" height="150px"/><br></td>
            </tr>
            <tr>
            <td ><br><label class="label">VISUALIZACION REGISTRO DEL CLIENTE</label><br>
            <br><input type="image" src="{!! asset('images/gafas.png') !!}" href= "{{url ('formulario')}}" width="200px" height="120px"/></td>
            <a href= "{{url ('/prediagnostico')}}" class="boton" >Usuarios pre registrados</a></br>
            <a href= "{{url ('registroCliente')}}" class="boton" >Registrar Clientes</a>
            </tr>
            </table>
            </div> 
            </div>
