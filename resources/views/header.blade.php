...
<body>
    <header>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0B2C80; font-color: black">
    ...
    <div class="collapse navbar-collapse flex-grow-1 text-right" id="myNavbar">
        <ul class="navbar-nav ml-auto flex-nowrap">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link">TIPOS DE VISA</a>
            </li>
            <li class="nav-item">
                <a href="{{route ('requisitosVista')}}" class="nav-link">REQUISITOS TRAMITE NO INMIGRANTE</a>
            </li>
            <li class="nav-item">
                <a href= "{{route ('formulario')}}" class="nav-link">PREDIAGNOSTICO</a>
            </li>
        </ul>
    </div>
</nav>
